...
function HeroDashboard() {
  return (
    <div className="relative mx-auto mt-16 w-full max-w-[1080px] overflow-hidden rounded-[22px] border border-[#e6efff] bg-white shadow-[0_30px_80px_rgba(93,144,224,0.18)]">
