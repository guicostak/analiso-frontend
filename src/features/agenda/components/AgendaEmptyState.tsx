...
import { CalendarX2, Bookmark } from 'lucide-react';
import { useRouter } from 'next/navigation';

interface AgendaEmptyStateProps {
  /** 'no-watchlist': usuário não tem empresas favoritas */
  /** 'no-events': tem watchlist mas sem eventos no período */
  reason?: 'no-watchlist' | 'no-events';
}

/**
 * Estado vazio da agenda com call-to-action contextual.
 */
      ...
      <div className="flex flex-1 flex-col items-center justify-center gap-4 p-8 text-center">
        ...
        <div>
          <h3 className="text-base font-semibold text-foreground">
            Adicione empresas às favoritas
          </h3>
