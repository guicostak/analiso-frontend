...
export function AccountShell({
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <header className="fixed left-0 right-0 top-0 z-20 border-b border-border bg-card/94 backdrop-blur xl:left-[240px]">
        <div className="flex h-[64px] items-center justify-between px-6">
          <h1 className="text-[17px] font-semibold text-foreground">Minha conta</h1>

          <div className="flex items-center gap-3">
            <button className="grid h-9 w-9 place-items-center rounded-[14px] border border-border bg-card text-purple-400 shadow-[0_6px_14px_rgba(15,23,40,0.04)]">
              <Settings2 className="h-4 w-4" />
            </button>
            <button className="grid h-9 w-9 place-items-center rounded-[14px] border border-border bg-card text-foreground shadow-[0_6px_14px_rgba(15,23,40,0.04)]">
              <User className="h-4 w-4" />
            </button>
            <button className="relative grid h-9 w-9 place-items-center rounded-[14px] border border-border bg-card text-foreground shadow-[0_6px_14px_rgba(15,23,40,0.04)]">
