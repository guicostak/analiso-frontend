        ...
        <div className="space-y-4">
          <article className="rounded-2xl border border-[#E2EDF5] bg-white p-6 shadow-sm">
            <div className="flex flex-wrap items-start justify-between gap-3">
              ...
              <div className="flex items-center gap-2">
                <span className="rounded-full border border-[#FDE68A] bg-[#FFFBEB] px-3 py-1 text-[13px] font-semibold text-[#D97706]">
            ...
            <div className="mt-3 rounded-xl border border-[#E2EDF5] bg-[#F8FAFD] p-4">
              ...
              <div className="relative pt-9">
                <div className="pointer-events-none absolute left-0 right-0 top-0">
                  <div className="absolute left-[56%] -translate-x-1/2 whitespace-nowrap rounded-xl border border-[#CFE9E1] bg-white px-2 py-1 text-[13px] font-semibold text-[#0F766E] shadow-sm">
                ...
                <div className="pointer-events-none absolute bottom-0 top-0 z-[1]" style={{ left: "54%" }}>
                  ...
                  <div className="absolute -top-5 -translate-x-1/2 whitespace-nowrap rounded-xl border border-[#CBD5E1] bg-white px-2 py-1 text-[13px] font-semibold text-[#0B1220] shadow-sm">
                    <span>Preço atual</span>
                    <span className="ml-1 text-[#475569]">R$ 48,10</span>
                  </div>
                </div>
              ...
              <div className="mt-3 grid gap-2 text-[12px] text-[#5B6472] sm:grid-cols-3">
                <p><span className="inline-block h-2 w-2 rounded-full bg-[#A6E7D6]" /> <span className="ml-1 font-medium text-[#334155]">Abaixo do preço justo</span></p>
                <p><span className="inline-block h-2 w-2 rounded-full bg-[#F2C86B]" /> <span className="ml-1 font-medium text-[#334155]">Próximo do preço justo</span></p>
                <p><span className="inline-block h-2 w-2 rounded-full bg-[#F1B4A8]" /> <span className="ml-1 font-medium text-[#334155]">Acima do preço justo</span></p>
              </div>
              <div className="mt-2">
          ...
          <section className="rounded-2xl border border-[#E2EDF5] bg-white p-5 shadow-sm">
            ...
            {valuationScenarios.map((scenario) => (
              <div key={scenario.scenario} className="grid grid-cols-4 border-b border-[#E2EDF5] py-3.5 text-[13px] text-[#334155]">
          ...
          <section className="rounded-2xl border border-[#E2EDF5] bg-white p-5 shadow-sm">
            ...
            <div className="mt-3 grid gap-3 sm:grid-cols-2">
              {sensitivityDrivers.map((driver) => (
                <div key={driver.driver} className="rounded-xl border border-[#E2EDF5] bg-[#F6FAFC] p-3">
          ...
          <section className="overflow-hidden rounded-2xl border border-[#E2EDF5] bg-white shadow-sm">
            ...
            {multiples.map((row) => (
              <div key={row.metric} className="grid grid-cols-5 border-b border-[#E2EDF5] px-5 py-3 text-[13px] text-[#334155] hover:bg-[#F6FAFC]">
