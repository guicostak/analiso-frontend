    ...
    <section className="space-y-5">
      <div className="flex items-center justify-between">
        <div>
          ...
          <h2 className="mt-2 text-[28px] font-semibold leading-8 tracking-[-0.03em] text-[#0F1728]">Contexto de mercado hoje</h2>
        </div>
        <button
          onClick={() => setShowContextPanel((prev) => !prev)}
          className="inline-flex items-center gap-2 rounded-full bg-white px-4 py-2 text-[12px] font-medium text-[#667085] shadow-[0_10px_28px_rgba(15,23,40,0.05)]"
        >
      ...
      {showContextPanel ? (
        <>
          <div className="grid gap-6 xl:grid-cols-12">
            <article className="relative overflow-hidden rounded-[28px] border border-[#DDE9F5] bg-[linear-gradient(135deg,#EEF6FF_0%,#F2F8FF_28%,#F7FBFF_62%,#FFFFFF_100%)] p-7 shadow-[0_24px_50px_rgba(15,23,40,0.07)] xl:col-span-8 xl:min-h-[248px]">
              ...
              <div className="relative flex h-full flex-col justify-between gap-7">
                <div className="max-w-[72%]">
                  ...
                  <h3 className="mt-5 text-[28px] font-semibold leading-[1.15] tracking-[-0.03em] text-[#0F1728]">
                ...
                <div className="relative grid gap-4 lg:grid-cols-[minmax(0,1.18fr)_228px]">
                  ...
                  <div className="relative rounded-[24px] border border-white/70 bg-[linear-gradient(180deg,rgba(255,255,255,0.88),rgba(255,255,255,0.66))] p-5 shadow-[0_14px_32px_rgba(15,23,40,0.05)]">
                    ...
                    <p className="mt-3 max-w-[95%] text-[15px] leading-7 text-[#0F1728]">
                  ...
                  <div className="relative rounded-[24px] border border-white/72 bg-[linear-gradient(180deg,rgba(255,255,255,0.76),rgba(255,255,255,0.56))] p-5 shadow-[0_10px_24px_rgba(15,23,40,0.04)]">
            ...
            <aside className="rounded-[28px] border border-[#E7EEF5] bg-white p-6 shadow-[0_18px_40px_rgba(15,23,40,0.05)] xl:col-span-4">
              <div className="mb-5">
                <p className="text-[12px] font-medium uppercase tracking-[0.08em] text-[#98A2B3]">Resumo dos indices</p>
                <p className="mt-2 text-[15px] leading-7 text-[#667085]">Mini cards para sentir direcao, ritmo e dispersao sem cara de terminal.</p>
              </div>
              ...
              {isLoading ? (
                ...
                <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                  {indexCards.map((card) => (
                    <div
                      key={card.symbol}
                      className={`relative overflow-hidden rounded-[20px] border border-[#EEF3F7] p-4 shadow-[0_10px_24px_rgba(15,23,40,0.03)] ${indexCardSurface[card.trend]}`}
                    >
                      ...
                      <p className="relative mt-4 text-[22px] font-semibold tracking-[-0.03em] text-[#0F1728]">{card.value}</p>
          ...
          <div className="rounded-[28px] border border-[#E7EEF5] bg-[linear-gradient(135deg,#FFF5E8_0%,#FFFFFF_78%)] p-6 shadow-[0_18px_40px_rgba(15,23,40,0.04)]">
            <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
              <div className="max-w-[760px]">
                ...
                <p className="mt-5 text-[32px] font-semibold leading-9 tracking-[-0.03em] text-[#0F1728]">{volatility.value}</p>
              ...
              <div className="flex flex-col gap-3 lg:min-w-[240px] lg:items-end">
                <button
                  ...
                  className="inline-flex h-11 items-center rounded-[16px] bg-white px-4 text-[14px] font-semibold text-[#0F1728] shadow-[0_12px_30px_rgba(15,23,40,0.06)] transition hover:bg-[#FCFDFE]"
                >
                  Ver detalhes
                </button>
